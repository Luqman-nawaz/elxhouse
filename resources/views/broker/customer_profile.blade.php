        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{$user->profile->adults}}">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{$user->profile->childerns}}">
                </div>
            </div>
            <div class="col-sm-4">
                 <label for="">House</label>
                 <input type="text" class="form-control" value="{{$user->profile->house}}">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{$user->profile->budget}}">
