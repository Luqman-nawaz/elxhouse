      ...
      <div class="card-body p-0 chat-body" id="conversactionbosy">
        ...
        <div class="mailbox-read-message" id="chatBody">
          @foreach ($chat as $item)
              ...
              <small style="display: block; margin-top:10px;">{{$item->user->name}}</small>
...
<script>
  $(document).ready(function(){
    ...
    //         res=response.data
    //         html='<br><div class="text-left mt-2"><span class="messages receive_messages">'+res.messages+'</span></div>';
    //        $("#chatBody").append(html)
    //       }
    //     }
    //   })
